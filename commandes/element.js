...
if(err || res.statusCode!== 200)return
    ...
    let filter = (message, Sender) => message.content === "Feu" || message.content === "Eau" || message.content === "Air" || message.content === "Terre" || message.content === "Ténèbres" || message.content === "Lumière" && Sender.id === message.author.id; 
